...
class CogVLMTokenizer:
    ...
    def encode(self, prompt):
        ...
        ids_chunks = self.tokenizer(prompt)
        input_ids = ids_chunks[0] + [self.tokenizer.pad_token_id] * self.image_length + ids_chunks[1:]

        return {"input_ids": input_ids, "lengths": self.image_length}
